...
def deploy(web3: Web3, deployer_address: str, deployer_privateKey: str, player_address: str) -> str:
    ...
    # TheOracleParadox Setup requires playerAddress and 100 ETH
    ...
    # Player starts with 23 ETH (as per the contract comment)
    set_balance(web3, player_address, Web3.to_wei(23, 'ether'))
